           ...
           <div class="col-md-12">
               <div class="card">
                   <div class="card-header">
                       ...
                       <div class="card-tolls float-right">
                           <button type="button" class="btn btn-primary" @click="reload">Reload <i class="fas fa-sync"></i></button>
                           <button type="button" class="btn btn-info" @click="create">Add New Customer <i class="fas fa-plus"></i></button>
                       </div>
                   </div>
                           ...
                           <table class="table table-striped table-bordered table-hover">
                               ...
                               <tr v-show="customers.length" v-for="(customer, index) in customers" :key="customer.id">
                                  ...
                                  <td class="text-center">
                                      <button type="button" @click="view(customer)" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></button>
               ...
               <div class="modal-content">
                   ...
                   <form @submit.prevent="editMode ? update() : store()" @keydown="form.onKeydown($event)">
                       ...
                       <div class="modal-footer">
                           ...
                           <button :disabled="form.busy" type="submit" class="btn btn-primary">{{ editMode ? 'Update' : 'Add'}} Customer</button>
                       </div>
                   </form>
               </div>
           </div>
                ...
                this.form.post('/api/customers/')
                    .then(response => {
                        ...
                        if(this.form.successful){
                            this.$Progress.finish()
                            this.$snotify.success('Customer Save Successfully !!','Success')
                        }
                        else {
                            this.$Progress.fail()
